...
const INVERSE_LUT = new Uint8Array([
  32, 32, 32, 32, 32, 32, 32, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 34, 34, 34, 34, 34,
  34, 34, 34, 34, 34, 34, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 36, 36, 36, 36, 36, 36, 36,
  36, 36, 36, 36, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 38, 38, 38, 38, 38, 38, 38, 38, 38, 39,
  39, 39, 39, 39, 39, 39, 39, 39, 40, 40, 40, 40, 40, 40, 40, 40, 40, 41, 41, 41, 41, 41, 41, 41,
  42, 42, 42, 42, 42, 42, 42, 43, 43, 43, 43, 43, 43, 43, 44, 44, 44, 44, 44, 44, 45, 45, 45, 45,
  45, 45, 45, 46, 46, 46, 46, 46, 47, 47, 47, 47, 47, 48, 48, 48, 48, 48, 48, 49, 49, 49, 49, 50,
  50, 50, 50, 50, 51, 51, 51, 51, 52, 52, 52, 52, 53, 53, 53, 53, 54, 54, 54, 55, 55, 55, 56, 56,
  56, 56, 57, 57, 57, 58, 58, 58, 59, 59, 60, 60, 60, 61, 61, 62, 62, 63, 63, 64, 64, 64, 65, 65,
  66, 66, 67, 68, 68, 69, 69, 70, 70, 71, 72, 73, 74, 74, 75, 75, 76, 77, 78, 80, 81, 82, 82, 83,
  84, 86, 87, 89, 91, 92, 92, 94, 96, 98, 100, 102, 105, 107, 108, 111, 114, 117, 121, 125, 130,
  133, 135, 140, 147, 154, 162, 171, 183, 190, 196, 212, 232, 255, 255, 255, 255, 255, 255, 255,
]);

export function convertAdditiveImage(img: HTMLImageElement | HTMLCanvasElement) {
  // 画像の黒い部分を透過
...
export function adjustAdditiveImage(img: HTMLImageElement) {
  // 画像のRGB成分を LUT の逆変換
  const { width, height } = img;
